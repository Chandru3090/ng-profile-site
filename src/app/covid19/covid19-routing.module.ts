...
const routes: Routes = [{ path: '', component: Covid19Component }, { path: 'covid19-india', component: Covid19IndiaComponent }, { path: 'covid19/country/:country', component: ViewbyCountryComponent }];
